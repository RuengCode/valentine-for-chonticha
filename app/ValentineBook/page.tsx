  ...
  return (
    <div>
              ...
              {showModal && (
                <dialog className="modal modal-open">
                  <div className="modal-box max-w-5xl">
                    <img src={selectedImage} alt="Ruengjarat" className="w-full h-auto" />
      ...
      <div className="bg-base-100 flex justify-center items-center p-4">
        <div className="card bg-base-200 text-base-content w-full md:w-[40rem]">
          <div className="card-body">
            ...
            {/* Post Content */}
            <p className="text-sm">
              When someone else's happiness is your happiness. That is love. May
              your Valentine's Day be filled.🤍🫰🤟
            </p>
      ...
      <div className="flex justify-center items-center pb-4">
        ...
        >
          มีอะไรอยากจะบอกเรามั้ย <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
